    ...
    <div className="px-6 py-6 flex flex-col gap-6">
      ...
      <div className=" flex justify-between">
        ...
        <div className=" flex gap-3">
          <Button
            className=" py-3 text-center items-center border-2 border-defaultTextColor w-full rounded-[40px] text-defaultTextColor  font-bold text-lg  "
            sx={{
              textTransform: "none",
            }}
          >
          ...
          <Button
            className=" py-3 text-center items-center bg-defaultTextColor w-full rounded-[40px] text-white  font-bold text-lg  "
            sx={{
              textTransform: "none",
            }}
          >
